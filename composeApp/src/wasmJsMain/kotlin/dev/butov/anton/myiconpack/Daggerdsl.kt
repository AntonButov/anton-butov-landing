...
val AntonIcons.DaggerDsl: ImageVector by lazy {
    Builder(name = "Daggerdsl", defaultWidth = 70.0.dp, defaultHeight = 69.0.dp,
                viewportWidth = 70.0f, viewportHeight = 69.0f).apply {
